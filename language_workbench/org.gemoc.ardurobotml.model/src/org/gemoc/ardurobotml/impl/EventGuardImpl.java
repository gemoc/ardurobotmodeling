 ...
 * <ul>
 *   <li>{@link org.gemoc.ardurobotml.impl.EventGuardImpl#getTriggeringEvent <em>Triggering Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventGuardImpl extends GuardImpl implements EventGuard {
	...
	protected EClass eStaticClass() {
		return ArdurobotmlPackage.Literals.EVENT_GUARD;
	}
		...
		if (triggeringEvent != null && triggeringEvent.eIsProxy()) {
			...
			if (triggeringEvent != oldTriggeringEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArdurobotmlPackage.EVENT_GUARD__TRIGGERING_EVENT, oldTriggeringEvent, triggeringEvent));
			}
		}
	...
	public void setTriggeringEvent(FSMEvent newTriggeringEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArdurobotmlPackage.EVENT_GUARD__TRIGGERING_EVENT, oldTriggeringEvent, triggeringEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArdurobotmlPackage.EVENT_GUARD__TRIGGERING_EVENT:
