...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Deceleratet Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.gemoc.ardurobotml.impl.DeceleratetActionImpl#getRatio <em>Ratio</em>}</li>
 *   <li>{@link org.gemoc.ardurobotml.impl.DeceleratetActionImpl#getStartTick <em>Start Tick</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeceleratetActionImpl extends ActionImpl implements DeceleratetAction {
	/**
	 ...
	 * @generated
	 */
	protected DeceleratetActionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ArdurobotmlPackage.Literals.DECELERATET_ACTION;
	}
	...
	public void setRatio(int newRatio) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArdurobotmlPackage.DECELERATET_ACTION__RATIO, oldRatio, ratio));
	}
	...
	public void setStartTick(int newStartTick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArdurobotmlPackage.DECELERATET_ACTION__START_TICK, oldStartTick, startTick));
	}
