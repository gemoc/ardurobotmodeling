...
/**
 * This is the item provider adapter for a {@link org.gemoc.ardurobotml.FSMClock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FSMClockItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FSMClock_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FSMClock_value_feature", "_UI_FSMClock_type"),
				 ArdurobotmlPackage.Literals.FSM_CLOCK__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FSMClock.class)) {
			case ArdurobotmlPackage.FSM_CLOCK__VALUE:
