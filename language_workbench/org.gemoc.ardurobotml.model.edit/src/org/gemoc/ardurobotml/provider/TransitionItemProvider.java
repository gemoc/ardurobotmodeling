...
/**
 * This is the item provider adapter for a {@link org.gemoc.ardurobotml.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArdurobotmlPackage.Literals.TRANSITION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArdurobotmlPackage.Literals.TRANSITION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addGeneratedEventsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_generatedEvents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_generatedEvents_feature", "_UI_Transition_type"),
				 ArdurobotmlPackage.Literals.TRANSITION__GENERATED_EVENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArdurobotmlPackage.Literals.TRANSITION__OWNED_GUARD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArdurobotmlPackage.Literals.TRANSITION__OWNED_GUARD,
				 ArdurobotmlFactory.eINSTANCE.createTemporalGuard()));

		newChildDescriptors.add
			(createChildParameter
				(ArdurobotmlPackage.Literals.TRANSITION__OWNED_GUARD,
				 ArdurobotmlFactory.eINSTANCE.createEventGuard()));

		newChildDescriptors.add
			(createChildParameter
				(ArdurobotmlPackage.Literals.TRANSITION__OWNED_GUARD,
				 ArdurobotmlFactory.eINSTANCE.createEvaluateGuard()));
	}
