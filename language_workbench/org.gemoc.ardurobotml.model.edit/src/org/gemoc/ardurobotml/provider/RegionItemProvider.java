...
/**
 * This is the item provider adapter for a {@link org.gemoc.ardurobotml.Region} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArdurobotmlPackage.Literals.REGION__NAME,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArdurobotmlPackage.Literals.REGION__OWNED_STATES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Region.class)) {
			case ArdurobotmlPackage.REGION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ArdurobotmlPackage.REGION__OWNED_STATES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArdurobotmlPackage.Literals.REGION__OWNED_STATES,
				 ArdurobotmlFactory.eINSTANCE.createState()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return ArdurobotmlEditPlugin.INSTANCE;
	}
