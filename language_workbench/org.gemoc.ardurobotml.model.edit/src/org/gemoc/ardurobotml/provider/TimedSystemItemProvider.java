...
/**
 * This is the item provider adapter for a {@link org.gemoc.ardurobotml.TimedSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimedSystemItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArdurobotmlPackage.Literals.TIMED_SYSTEM__TFSMS);
			childrenFeatures.add(ArdurobotmlPackage.Literals.TIMED_SYSTEM__GLOBAL_CLOCKS);
			childrenFeatures.add(ArdurobotmlPackage.Literals.TIMED_SYSTEM__GLOBAL_EVENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArdurobotmlPackage.Literals.TIMED_SYSTEM__TFSMS,
				 ArdurobotmlFactory.eINSTANCE.createTFSM()));

		newChildDescriptors.add
			(createChildParameter
				(ArdurobotmlPackage.Literals.TIMED_SYSTEM__GLOBAL_CLOCKS,
				 ArdurobotmlFactory.eINSTANCE.createFSMClock()));

		newChildDescriptors.add
			(createChildParameter
				(ArdurobotmlPackage.Literals.TIMED_SYSTEM__GLOBAL_EVENTS,
